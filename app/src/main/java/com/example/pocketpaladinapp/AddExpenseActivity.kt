...
class AddExpenseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        * the above reference was used to understand and implement the image picker
        */
        ...
        btnSaveExpense.setOnClickListener {
            ...
            if (description.isEmpty() || date.isEmpty() || startTime.isEmpty() || amount == null) {
                Toast.makeText(this, "Please fill in all required fields with valid data", Toast.LENGTH_SHORT).show()
